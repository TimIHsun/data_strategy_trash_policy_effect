...
unique(trashBefore$統計區)[c(2:length(unique(trashBefore$統計區)))] -> city
...
ggplot(data = Changhua,aes(x= Changhua$統計期, y= Changhua$`平均每人每日一般廢棄物產生量 (公斤)`)) +
  ...
  scale_x_date(
      breaks = c(as.Date("2001-01-01"),seq(as.Date("2005-01-01"), as.Date("2019-12-01"), by="5 year"),as.Date("2019-12-01")),
      labels = c("2001-01", "2005-01", "2010-01", "2015-01", "2019-01")
      )->Changhua_NTP
