...
for (i in 1:length(NewTPYearMonth)){
  ...
  if (length(NewTPYearMonth[[i]])==2){
    paste0(NewTPYearMonth[[i]][[1]],"-",NewTPYearMonth[[i]][[2]]) -> NewTPYearMonth[[i]]
  }else if(length(NewTPYearMonth[[i]])==3){
    paste0(NewTPYearMonth[[i]][[1]],"-",NewTPYearMonth[[i]][[2]],"-",NewTPYearMonth[[i]][[3]]) -> NewTPYearMonth[[i]]
  }
}
...
for (i in 1:length(TaoyuanYearMonth)){
  ...
  if (length(TaoyuanYearMonth[[i]])==2){
    paste0(TaoyuanYearMonth[[i]][[1]],"-",TaoyuanYearMonth[[i]][[2]]) -> TaoyuanYearMonth[[i]]
  }else if(length(TaoyuanYearMonth[[i]])==3){
    paste0(TaoyuanYearMonth[[i]][[1]],"-",TaoyuanYearMonth[[i]][[2]],"-",TaoyuanYearMonth[[i]][[3]]) -> TaoyuanYearMonth[[i]]
  }
}
...
for (i in 1:length(TaipeiYearMonth)){
  ...
  if (length(TaipeiYearMonth[[i]])==2){
    paste0(TaipeiYearMonth[[i]][[1]],"-",TaipeiYearMonth[[i]][[2]]) -> TaipeiYearMonth[[i]]
  }else if(length(TaipeiYearMonth[[i]])==3){
    paste0(TaipeiYearMonth[[i]][[1]],"-",TaipeiYearMonth[[i]][[2]],"-",TaipeiYearMonth[[i]][[3]]) -> TaipeiYearMonth[[i]]
  }
}
